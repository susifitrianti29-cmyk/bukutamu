...
<body>
  <div class="container">
    ...
    <?php
    // Jalankan query dengan pengecekan
    $sql = "SELECT * FROM buku_tamu ORDER BY id DESC";
    $data = mysqli_query($koneksi, $sql);

    if ($data === false) {
        // Jika query gagal tampilkan pesan error (untuk debugging). Di produksi, tampilkan pesan umum.
        echo '<div class="msg">Terjadi kesalahan pada query: ' . htmlspecialchars(mysqli_error($koneksi)) . '</div>';
    } else {
        // Jika tidak ada baris, tampilkan pesan
